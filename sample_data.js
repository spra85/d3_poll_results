...
//http://www.theonion.com/articles/what-do-you-think-of-steve-ballmer-spending-2-bill,36164/
...
usStates.forEach(function(state) {
  SampleData.results[state.abbreviation] = {};

  Object.keys(SampleData.jokes).forEach(function(jokeId) {
    var numberOfVotes = _.random(1000, 10000);
    SampleData.results[state.abbreviation][jokeId] = numberOfVotes;
    SampleData.jokes[jokeId].votes = SampleData.jokes[jokeId].votes + numberOfVotes;
  });
});
